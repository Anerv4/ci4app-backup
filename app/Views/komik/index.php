        ...
        <div class="page-content">
          <div class="col-lg-12">
            <div class="main-button">
              <a href="/komik/create">Tambah Data Komik</a>
            </div>
            <!-- Session Flesh data -->
          ...
          <div class="gaming-library">
            <div class="col-lg-12">
              <div class="heading-section">
                <h4><em>Comic</em> Library</h4>
              </div>
              <?php $i = 1 + (10 * ($currentPage -1));?>
              <?php foreach ($komikPaginate as $k) :?>
              <div class="item ">
                <ul>
                  <li><img src="/img/<?= $k['sampul']; ?>" alt="" class="templatemo-item"></li>
                  <li><h4>Judul</h4><span><?= $k['judul']; ?></span></li>
                  <li><h4>Genre</h4><span><?= $k['genre']; ?></span></li>
                  <li><h4>Slug</h4></h4><span><?= $k['slug']; ?></span></li>
                  <li><h4>Currently</h4><span>Downloaded</span></li>
                  <li><div class="main-border-button"><a href="/komik/<?= $k['slug']; ?>">Detail</a></div></li>
                </ul>
              </div>
              <?php endforeach; ?>
